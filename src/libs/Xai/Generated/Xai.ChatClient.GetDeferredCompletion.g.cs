...
namespace Xai
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Xai.EndPointSecurityRequirement s_GetDeferredCompletionSecurityRequirement0 =
        ...
        private static readonly global::Xai.EndPointSecurityRequirement[] s_GetDeferredCompletionSecurityRequirements =
            new global::Xai.EndPointSecurityRequirement[]
            {                s_GetDeferredCompletionSecurityRequirement0,
            };
        partial void PrepareGetDeferredCompletionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string requestId);
        partial void PrepareGetDeferredCompletionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string requestId);
        partial void ProcessGetDeferredCompletionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDeferredCompletionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Xai.CreateChatCompletionResponse> GetDeferredCompletionAsync(
            string requestId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetDeferredCompletionAsResponseAsync(
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.CreateChatCompletionResponse>> GetDeferredCompletionAsResponseAsync(
            string requestId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDeferredCompletionArguments(
            ...
            var __authorizations = global::Xai.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDeferredCompletionSecurityRequirements,
                operationName: "GetDeferredCompletionAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Xai.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetDeferredCompletionAsync",
                                pathTemplate: "$\"/chat/deferred-completion/{requestId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDeferredCompletionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Xai.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDeferredCompletionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Xai.CreateChatCompletionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Xai.AutoSDKHttpResponse<global::Xai.CreateChatCompletionResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Xai.CreateChatCompletionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
