...
namespace Xai
{
    public partial class CustomVoicesClient
    {
        ...
        {
            var __response = await UpdateCustomVoiceAsResponseAsync(
                voiceId: voiceId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.CustomVoice>> UpdateCustomVoiceAsResponseAsync(
            string voiceId,
