...
namespace Xai
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Xai.EndPointSecurityRequirement s_GetEmbeddingModelSecurityRequirement0 =
        ...
        private static readonly global::Xai.EndPointSecurityRequirement[] s_GetEmbeddingModelSecurityRequirements =
            new global::Xai.EndPointSecurityRequirement[]
            {                s_GetEmbeddingModelSecurityRequirement0,
            };
        partial void PrepareGetEmbeddingModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string modelId);
        partial void PrepareGetEmbeddingModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string modelId);
        partial void ProcessGetEmbeddingModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEmbeddingModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Xai.Model> GetEmbeddingModelAsync(
            string modelId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetEmbeddingModelAsResponseAsync(
                modelId: modelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.Model>> GetEmbeddingModelAsResponseAsync(
            string modelId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEmbeddingModelArguments(
            ...
            var __authorizations = global::Xai.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEmbeddingModelSecurityRequirements,
                operationName: "GetEmbeddingModelAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEmbeddingModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Xai.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetEmbeddingModelAsync",
                                pathTemplate: "$\"/embedding-models/{modelId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEmbeddingModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Xai.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEmbeddingModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
