...
namespace Xai
{
    public partial class VideosClient
    {
        ...
        {
            var __response = await GetVideoStatusAsResponseAsync(
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.VideoStatusResponse>> GetVideoStatusAsResponseAsync(
            string requestId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Xai.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetVideoStatusAsync",
                                pathTemplate: "$\"/videos/{requestId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Xai.VideoStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Xai.AutoSDKHttpResponse<global::Xai.VideoStatusResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Xai.VideoStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
