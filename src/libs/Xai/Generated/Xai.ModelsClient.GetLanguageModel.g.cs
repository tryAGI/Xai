...
namespace Xai
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Xai.EndPointSecurityRequirement s_GetLanguageModelSecurityRequirement0 =
        ...
        private static readonly global::Xai.EndPointSecurityRequirement[] s_GetLanguageModelSecurityRequirements =
            new global::Xai.EndPointSecurityRequirement[]
            {                s_GetLanguageModelSecurityRequirement0,
            };
        partial void PrepareGetLanguageModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string modelId);
        partial void PrepareGetLanguageModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string modelId);
        partial void ProcessGetLanguageModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetLanguageModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Xai.Model> GetLanguageModelAsync(
            string modelId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetLanguageModelAsResponseAsync(
                modelId: modelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.Model>> GetLanguageModelAsResponseAsync(
            string modelId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetLanguageModelArguments(
            ...
            var __authorizations = global::Xai.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetLanguageModelSecurityRequirements,
                operationName: "GetLanguageModelAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetLanguageModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Xai.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetLanguageModelAsync",
                                pathTemplate: "$\"/language-models/{modelId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetLanguageModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Xai.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetLanguageModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
