...
namespace Xai
{
    public partial class CustomVoicesClient
    {
        ...
        private static readonly global::Xai.EndPointSecurityRequirement s_ListCustomVoicesSecurityRequirement0 =
        ...
        private static readonly global::Xai.EndPointSecurityRequirement[] s_ListCustomVoicesSecurityRequirements =
            new global::Xai.EndPointSecurityRequirement[]
            {                s_ListCustomVoicesSecurityRequirement0,
            };
        partial void PrepareListCustomVoicesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? paginationToken);
        partial void PrepareListCustomVoicesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string? paginationToken);
        partial void ProcessListCustomVoicesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListCustomVoicesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Xai.ListCustomVoicesResponse> ListCustomVoicesAsync(
            int? limit = default,
            string? paginationToken = default,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListCustomVoicesAsResponseAsync(
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.ListCustomVoicesResponse>> ListCustomVoicesAsResponseAsync(
            int? limit = default,
            string? paginationToken = default,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListCustomVoicesArguments(
            ...
            var __authorizations = global::Xai.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListCustomVoicesSecurityRequirements,
                operationName: "ListCustomVoicesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListCustomVoicesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Xai.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListCustomVoicesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListCustomVoicesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Xai.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListCustomVoicesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Xai.ListCustomVoicesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Xai.AutoSDKHttpResponse<global::Xai.ListCustomVoicesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Xai.ListCustomVoicesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
