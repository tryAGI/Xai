...
namespace Xai
{
    public partial class CustomVoicesClient
    {
        ...
        private static readonly global::Xai.EndPointSecurityRequirement s_DeleteCustomVoiceSecurityRequirement0 =
        ...
        private static readonly global::Xai.EndPointSecurityRequirement[] s_DeleteCustomVoiceSecurityRequirements =
            new global::Xai.EndPointSecurityRequirement[]
            {                s_DeleteCustomVoiceSecurityRequirement0,
            };
        partial void PrepareDeleteCustomVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceId);
        partial void PrepareDeleteCustomVoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string voiceId);
        partial void ProcessDeleteCustomVoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteCustomVoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Xai.DeleteCustomVoiceResponse> DeleteCustomVoiceAsync(
            string voiceId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteCustomVoiceAsResponseAsync(
                voiceId: voiceId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Xai.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Xai.AutoSDKHttpResponse<global::Xai.DeleteCustomVoiceResponse>> DeleteCustomVoiceAsResponseAsync(
            string voiceId,
            global::Xai.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteCustomVoiceArguments(
            ...
            var __authorizations = global::Xai.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteCustomVoiceSecurityRequirements,
                operationName: "DeleteCustomVoiceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteCustomVoiceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Xai.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Xai.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteCustomVoiceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteCustomVoiceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Xai.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteCustomVoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Xai.DeleteCustomVoiceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Xai.AutoSDKHttpResponse<global::Xai.DeleteCustomVoiceResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Xai.DeleteCustomVoiceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
